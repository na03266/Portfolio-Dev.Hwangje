...
| 기간 | 프로젝트 명 | 내용     |
|:----|:---------|:--------|
| 2023.09.19 - 2023.10.12 | **[학생 출석 시스템](#ios-옛다)**  <br> *교내 졸업작품 경진대회* | 안면인식 기능을 기본으로 한 출석  <br> **PART** : 백엔드 및 서버 부분 (기여도 25%) <br> **LIST** : 백엔드/서버 설계서, 인증, 보안, 서버, 라우팅, 데이터베이스, 딥러닝  <br> **STACK** : `Node.js`, `Linux`, `Oracle`, `Deeplearning`|
